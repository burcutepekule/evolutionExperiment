function [] = RUN_MCMC_ALL_SIMUL_PARALLEL(readDataDirec,commIdx,thrIncl,offset,LB,UB,x0,burnin,sampleevery,njumps,kernel,sig,filname)
offset  = offset+1;
